...
Eval<Ir> _createInputChip(Properties properties) {
  final inputChipWidget = InputChip(
    ...
    onDeleted: properties.inputChipOnDeleted,
    deleteIconColor: properties.inputChipDeleteIconColor,
    deleteButtonTooltipMessage: properties.inputChipDeleteButtonTooltipMessage,
    onSelected: properties.inputChipOnSelected,
    onPressed: properties.inputChipOnPressed,
  ...
  return Eval.pure(IrNativeValue(Value(inputChipWidget)));
}
