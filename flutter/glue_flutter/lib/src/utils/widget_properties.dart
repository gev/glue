...
class Properties {
  ...
  bool? get disabled => extractBool(_props['disabled']);
  ...
  Axis? get direction => extractAxis(_props['direction']);
  double? get spacing => extractDouble(_props['spacing']);

  // Container properties
  EdgeInsetsGeometry? get padding => extractEdgeInsets(_props['padding']);
}
