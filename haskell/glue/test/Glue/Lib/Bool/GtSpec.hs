...
spec = describe "Glue.Lib.Bool.Gt (Test gt function)" do
    describe "Greater than comparison" do
        it "returns true for greater number" do
            ...
            result <- runEvalSimple (gt args) (E.fromFrame lib)
            case result of
        ...
        it "> alias works identically to gt" do
            ...
            result1 <- runEvalSimple (gt args1) (E.fromFrame lib)
            result2 <- runEvalSimple (gt args2) (E.fromFrame lib)
            result3 <- runEvalSimple (gt args3) (E.fromFrame lib)
