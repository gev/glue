...
spec = describe "Reactor.Lib.Bool.Ge (Test ge function)" do
    describe "Greater than or equal comparison" do
        it "returns true for equal numbers" do
            ...
            result <- runEval (ge args) (E.fromFrame lib)
            case result of
        ...
        it ">= alias works identically to ge" do
            ...
            result1 <- runEval (ge args1) (E.fromFrame lib)
            result2 <- runEval (ge args2) (E.fromFrame lib)
            result3 <- runEval (ge args3) (E.fromFrame lib)
