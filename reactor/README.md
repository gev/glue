...
For technical details about the AST and IR representations, see [`AST.md`](AST.md), [`IR.md`](IR.md), [`COMPILATION.md`](COMPILATION.md), [`EVALUATION.md`](EVALUATION.md), and [`EVALSTATE.md`](EVALSTATE.md).
