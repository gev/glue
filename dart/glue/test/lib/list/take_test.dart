...
void main() {
  group('Glue.Lib.List.Take (take)', () {
    test('takes first N elements from list', () {
      final args = [
        IrInteger(3),
        IrList([
          IrInteger(1),
      ...
      final result = runEvalSimple(apply(take, args), emptyEnv());
    ...
    test('takes fewer elements when N > list length', () {
      final args = [
        IrInteger(10),
    ...
    test('takes all elements when N equals list length', () {
      final args = [
        IrInteger(3),
        IrList([IrInteger(1), IrInteger(2), IrInteger(3)]),
      ];
