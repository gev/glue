...
Future<Either<EvalError, Ir?>> runCode(List<Ir> args) async {
  ...
  final evalResult = await runEval(apply(ne, args), runtime);
...
void main() {
  group('Glue.Lib.Bool.Ne (Test ne function)', () {
    group('Inequality comparison', () {
      test('returns true for unequal numbers', () async {
      ...
      test('returns false for equal numbers', () async {
      ...
      test('returns true for unequal strings', () async {
      ...
      test('returns false for equal strings', () async {
