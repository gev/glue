...
Either<EvalError, Ir?> runCode(List<Ir> args) {
  ...
  final evalResult = runEval(apply(le, args), runtime);
...
void main() {
  group('Glue.Lib.Bool.Le (Test le function)', () {
    group('Less than or equal comparison', () {
      test('returns true for smaller integer', () {
      ...
      test('returns false for larger integer', () {
