...
void main() {
  group('Glue.Lib.Math.Trigonometric.Sin (sin)', () {
    test('sin with common angles', () {
    ...
    test('fails with wrong argument types', () {
      final result = runCode('(sin "hello")');
